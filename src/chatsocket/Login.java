...
//        System.out.println(this.username + " "+ this.password);
        if(this.aCtr.checkAcc(this.username, this.password)){
            AllChatFrame chatAll = new AllChatFrame(this.username);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        this.username = jTextField1.getText();
        this.password = jTextField2.getText();
        Account acc = new Account(this.username, this.password);
        if(aCtr.insert(acc) != 0){
            AllChatFrame chatAll = new AllChatFrame(this.username);
            chatAll.setVisible(true);
            this.setVisible(false);
        }
